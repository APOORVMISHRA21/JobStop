...
public class SharedPreferences {
    ...
    public Boolean getShown() {
        return this.prefs.getBoolean("mode", false);
    }

    public void setShown(Boolean state) {
        editor.putBoolean("mode", state);
        editor.apply();
    }

    public Boolean getFirstTime() {
        return this.prefs.getBoolean("night_mode", true);
    }
    ...
    // 100 => Student, 200 => Recruiter
    public void setCurrentUserType(int userId) {
        editor.putInt("user_id", userId);
        editor.apply();
    }

    public int getCurrentUserType(){
        return this.prefs.getInt("user_id", 100);
    }
}
